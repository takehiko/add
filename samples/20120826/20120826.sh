...
param1="-size 184x142 xc:white -strokewidth 2.5"
param2="-strokewidth 2"
...
round="5 5"
grp="translate 2 2 fill none stroke grey35"
...
convert $param1 -draw "$rings" 3x4-none-noframe.png
convert $param1 -draw "$rings" $param2 -draw "$grp $cols" 3x4-col-noframe.png
convert $param1 -draw "$rings" $param2 -draw "$grp $rows" 3x4-row-noframe.png
convert $param1 -draw "$rings" $param2 -draw "$grp $cols $rows" 3x4-row+col-noframe.png
